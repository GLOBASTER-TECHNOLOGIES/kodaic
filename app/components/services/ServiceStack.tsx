...
const services = [
    {
        ...
        description: "High-performance web ecosystems. We architect SEO-dominant Next.js and React applications optimized for speed, interactivity, and conversion.",
        tags: ["Next.js", "React", "Vercel / Edge"],
        icon: Globe,
    },
    {
        id: "02",
        title: "Android",
        subtitle: "& Mobile",
        description: "Native-grade experiences. We specialize in high-performance Android development (Kotlin) and scalable cross-platform solutions that feel instant.",
        tags: ["Kotlin", "Jetpack Compose", "React Native"],
        icon: Smartphone,
    },
    {
        id: "03",
        title: "Custom",
        subtitle: "Software",
        description: "Bespoke logic engines. We build tailored internal tools, APIs, and backend architectures designed to solve your specific operational bottlenecks.",
        tags: ["System Architecture", "Node.js", "Python"],
        icon: Code2,
    },
    {
        id: "04",
        title: "Cloud",
        subtitle: "& DevOps",
        description: "Deployment and optimization. We design self-healing cloud infrastructure on AWS/Azure, ensuring your software is secure, scalable, and cost-efficient.",
        tags: ["AWS / Azure", "CI/CD Pipelines", "Docker"],
        icon: Cloud,
    },
];
